...
import { ExtraInfoButton } from '../ExtraInfoButton/index';
import { COLORS, ColorKey } from '../../constants/pokemons';
import { PokemonInfo } from '../PokemonInfo';
import { PokemonDataProps } from '../../types/types';


export const PokemonCard = ( pokemonData : PokemonDataProps) => {
    const {
        name,
        type,
        color,
    ...
    return (
        <>
            ...
            >
                ...
                <div className="pointer-events-none absolute h-full w-full rounded-2xl opacity-10"></div>
                ...
                <div className="relative mb-4 flex flex-col items-center justify-center">
                    ...
                    <div className="flex h-[40px] w-[200px] items-center justify-center rounded-lg bg-stone-50 text-2xl font-medium text-gray-800">
                        <span>{type}</span>
                    </div>
                </div>
